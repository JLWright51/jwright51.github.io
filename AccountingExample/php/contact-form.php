...
if(isset($_POST["action"])) {
	...
	$headers = 'From: Launchpoint Designs Contact Form <JakeLWright51@gmail>' . "\r\n";

	$to = 'contact@launchpointdesigns.com';     // Recipient's email address
	$subject = 'Consultation Request'; // Message title
